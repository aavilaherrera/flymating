...
(CG6201) transcribed in the opposite direction of gr32a. It is 3,798 bp long.
We had previously analyzed a 661 bp sub-region immediately upstream gr32a.

## Coordinates

#### dm6: `chr2L:11,110,412-11,114,209`
...
**NB: UCSC browser coordinates start at 1 and include the end of the interval, i.e.
"1-offset closed". MAF and BED formats start counting with 0 (0-offset). BED
format does not include the stop coordinate in the interval---it is
"right-open"**

Intron/CDS/UTR/intergenic regions were obtained from the UCSC Table Browser in
BED format. "Intergenic" is the 3.7kbp region minus "whole gene" features. I
