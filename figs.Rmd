...
allbr_hist + facet_grid(isConsEl~isIntergenic, labeller = label_both)
```
...
mel_hist + facet_grid(isConsEl~isIntergenic, labeller = label_both)
```
...
sim_hist + facet_grid(isConsEl~isIntergenic, labeller = label_both)
```
...
- A score of 2 or -2 corresponds to a raw P-value of 0.01 for that base
...
# Per-feature PhyloP tests

## Load per-feature results
